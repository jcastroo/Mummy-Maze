...
public class MainFrame extends JFrame {
    ...
    static final String initialString = 	"             \n" +
                                            ...
                                            " . . . . . . \n" +
                                            "             \n";
    static final char[][] initialMatrix = Conversor.CONVERSOR.strToMatrix(initialString);
        ...
        SwingWorker worker = new SwingWorker<Solution, Void>() {
            ...
            public Solution doInBackground() {
                ...
                try {
                    ...
                    Solution solutionOfSearch = agent.solveProblem(problem);
                    if(solutionOfSearch == null){
                    }else{
