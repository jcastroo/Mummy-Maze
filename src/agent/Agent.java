...
public class Agent<E extends State> {
    ...
    public LinkedList<MummyMazeState> lms;
    ...
    public Solution solveProblem(Problem problem) { //recebe problema devolve solução
        if (heuristic != null) {
        ...
        searchMethod.getStatistics().setDuration(System.currentTimeMillis()-t);
        return solution;
    }
    ...
    public void executeSolution() {    
        for(Action action : solution.getActions()){
            ...
            //lms.add((MummyMazeState) environment);
        }
    }
    ...
    public String getSearchReport() {
        ...
        sb.append("Tempo: " + searchMethod.getStatistics().getDuration()+ "s\n");
